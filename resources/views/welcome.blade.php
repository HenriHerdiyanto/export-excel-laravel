        ...
        <div class="container position-relative">
            <div class="row gy-5" data-aos="fade-in">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
                    <h2>Welcome to <br> <span>MediaBaseCode</span></h2>
                    <p>Kami memberikan yang terbaik untuk Anda <br> Penyedia layanan pembuatan website
                    </p>
                ...
                <div class="col-lg-6 order-1 order-lg-2">
                    <!-- <img class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="100" src="assets/img/mediabasecode.jpg"> -->
                ...
                <div class="row gy-4 mt-5">
                    ...
                    <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="icon-box">
                            ...
                            <h4 class="title"><a href="" class="stretched-link">Pembuatan website</a></h4>
                        </div>
                    </div><!--End Icon Box -->
                    ...
                    <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="icon-box">
                            ...
                            <h4 class="title"><a href="" class="stretched-link">Optimisasi mesin pencari</a></h4>
                        </div>
                    </div><!--End Icon Box -->
                    ...
                    <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="icon-box">
                            ...
                            <h4 class="title"><a href="" class="stretched-link">Pemeliharaan website</a></h4>
                        </div>
                    </div><!--End Icon Box -->
                    ...
                    <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="500">
                        <div class="icon-box">
                            ...
                            <h4 class="title"><a href="" class="stretched-link">Pemasaran digital</a></h4>
                        </div>
                    </div><!--End Icon Box -->
    ...
    <main id="main">
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    <div class="col-lg-6">
                        <img class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="100"
                            src="assets/img/logo.JPG">
                        <!-- <img src="assets/img/about.jpg" class="img-fluid rounded-4 mb-4" alt=""> -->
                    </div>
                    <div class="col-lg-6">
                        <p align="justify">Selamat datang di <b>MediaBaseCode</b> Kami adalah penyedia layanan pembuatan
                            website
                            yang berkomitmen
                            untuk memberikan solusi yang tepat dan efektif bagi kebutuhan online Anda. Kami mengkhususkan
                            diri dalam
                            membantu bisnis kecil dan menengah untuk meningkatkan kehadiran mereka di internet melalui
                            website yang
                            profesional dan mudah digunakan.</p>
                        <p align="justify">Tim ahli kami terdiri dari desainer web dan pengembang yang berpengalaman dan
                            selalu siap
                            membantu Anda
                            dalam setiap tahap pembuatan website, mulai dari perencanaan, desain, pengembangan, hingga
                            peluncuran dan
                            pemeliharaan website Anda. Kami memahami bahwa setiap bisnis memiliki kebutuhan yang
                            berbeda-beda, oleh
                            karena itu, kami menawarkan berbagai pilihan paket pembuatan website yang dapat disesuaikan
                            dengan
